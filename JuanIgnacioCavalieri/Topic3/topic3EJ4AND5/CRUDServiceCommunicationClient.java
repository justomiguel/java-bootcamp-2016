...
/**
 *Class CRUDServiceCommunicationClient corresponding to the Topic 3 of Java bootcamp
 *It is used to get a communication mechanism between the client and the service
 *@author Juan Ignacio Cavalieri
 *@version 2016
 */
public class CRUDServiceCommunicationClient implements CRUDService {

	CRUDService communication;
	
	/**
     * Constructor of the class
     */
	public CRUDServiceCommunicationClient (){
		communication = new CRUDServiceImp ();
	}
	...
	public void connect(String URL, String User, String Pass) {
		...
		communication.connect(URL, User, Pass);
	}
	...
	public void insert(Element newElement) {
		// TODO Auto-generated method stub
		communication.insert(newElement);
	}
	...
	public void update(int index, String name, String description) {
		// TODO Auto-generated method stub
		communication.update(index, name, description);
	}
