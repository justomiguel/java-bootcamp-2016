...
/**
 *Class CRUDServiceProxy corresponding to the Topic 3 of Java bootcamp
...
public class CRUDServiceProxy implements CRUDService {
	...
	public void connect(String URL, String User, String Pass) {
		...
		implementation.connect(URL, User, Pass);
	}
	...
	public void insert(Element newElement) {
		// TODO Auto-generated method stub
		implementation.insert(newElement);
	}
	...
	public void update(int index, String name, String description) {
		// TODO Auto-generated method stub
		implementation.update(index, name, description);
	}
